		...
		$.fn.poptrox = function(options) {
			...
			// Settings
				var settings = $.extend({
					...
					popupBackgroundColor:			'#2c3e50',					// (Default Style) Popup background color (when usePopupStyling = true)
					popupTextColor:					'#34495e',					// (Default Style) Popup text color (when usePopupStyling = true)
					popupLoaderTextSize:			'2em',						// (Default Style) Popup loader text size
					popupCloserBackgroundColor:		'#34495e',					// (Default Style) Popup closer background color (when usePopupStyling = true)
					...
					if (settings.usePopupDefaultStyling) {
						...
						if ($nav.length == 2) {
							...
							$nav_next
								.css('right', '0')
								.css('width', wn)
								.html('<div style="position: absolute; padding:10px 15px; background:#34495e; top: 50%; margin-top: -20px; flota:right; right:-30px;"><i class="fa fa-chevron-right"></i></div>');

							$nav_previous
								.css('left', '0')
								.css('width', wp)
								.html('<div style="position: absolute; padding:10px 15px; background:#34495e; top: 50%; margin-top: -20px; flota:left; left:-30px;"><i class="fa fa-chevron-left"></i></div>');
